...
const PROCESS_ID = "410476";
const PROCESS_NAME = "exactly";
...
const ATTACHMENTS_PATHS: string[] = [
  "/public/410476/attachmentss/Profile.tsx"
];
const ATTACHMENTS_NAMES: string[] = [
  "Profile.tsx"
];
const ATTACHMENTS_DIRECTORY = "public/410476/attachmentss";
...
export const processData = async (
  ...
  try {
    ...
    // Prepare the prompt
    const generatedPrompt = "only use tailwind \n\nFollow these instructions strictly:\nValidation: error free" + inputText;
