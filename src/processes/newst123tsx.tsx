...
const PROCESS_ID = "724666";
const PROCESS_NAME = "newst123";
...
const ATTACHMENTS_PATHS: string[] = [
  "/public/724666/attachmentss/Profile.tsx"
];
const ATTACHMENTS_NAMES: string[] = [
  "Profile.tsx"
];
const ATTACHMENTS_DIRECTORY = "public/724666/attachmentss";
...
export const processData = async (
  ...
  try {
    ...
    // Prepare the prompt
    const generatedPrompt = "use tailwind no components\n\nFollow these instructions strictly:\nValidation: error free" + inputText;
