...
const PROCESS_ID = "732530";
const PROCESS_NAME = "setu222";
...
const ATTACHMENTS_PATHS: string[] = [
  "/public/732530/attachmentss/Profile.tsx"
];
const ATTACHMENTS_NAMES: string[] = [
  "Profile.tsx"
];
const ATTACHMENTS_DIRECTORY = "public/732530/attachmentss";
...
export const processData = async (
  ...
  try {
    ...
    // Prepare the prompt
    const generatedPrompt = "use tailwind only no components\n\nFollow these instructions strictly:\nValidation: error  free" + inputText;
