...
const PROCESS_ID = "166887";
const PROCESS_NAME = "setu";
...
const ATTACHMENTS_PATHS: string[] = [
  "/public/166887/attachmentss/Profile.tsx"
];
const ATTACHMENTS_NAMES: string[] = [
  "Profile.tsx"
];
const ATTACHMENTS_DIRECTORY = "public/166887/attachmentss";
...
export const processData = async (
  ...
  try {
    ...
    // Prepare the prompt
    const generatedPrompt = "use only tailwind no components\n\nFollow these instructions strictly:\nValidation: error free" + inputText;
