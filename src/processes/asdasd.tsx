...
const PROCESS_ID = "300712";
const PROCESS_NAME = "asdasd";
...
const ATTACHMENTS_PATHS: string[] = [
  "/public/300712/attachmentss/Profile.tsx"
];
const ATTACHMENTS_NAMES: string[] = [
  "Profile.tsx"
];
const ATTACHMENTS_DIRECTORY = "public/300712/attachmentss";
...
export const processData = async (
  ...
  try {
    ...
    // Prepare the prompt
    const generatedPrompt = "adasd\n\nFollow these instructions strictly:\nValidation: no wrror" + inputText;
