...
const PROCESS_ID = "700367";
const PROCESS_NAME = "nextjson";
...
const ATTACHMENTS_PATHS: string[] = [
  "/public/700367/attachmentss/Profile.tsx"
];
const ATTACHMENTS_NAMES: string[] = [
  "Profile.tsx"
];
const ATTACHMENTS_DIRECTORY = "public/700367/attachmentss";
