...
const PROCESS_ID = "700358";
const PROCESS_NAME = "todaysgood";
...
const ATTACHMENTS_PATHS: string[] = [
  "/public/700358/attachmentss/Profile.tsx"
];
const ATTACHMENTS_NAMES: string[] = [
  "Profile.tsx"
];
const ATTACHMENTS_DIRECTORY = "public/700358/attachmentss";
...
export const processData = async (
  ...
  try {
    ...
    // Prepare the prompt
    const generatedPrompt = "use only tailwind\n\nFollow these instructions strictly:\nValidation: error free" + inputText;
