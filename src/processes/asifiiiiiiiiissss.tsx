...
const PROCESS_ID = "180833";
const PROCESS_NAME = "asifiiiiiiiiissss";
...
const ATTACHMENTS_PATHS: string[] = [
  "/public/180833/attachmentss/Profile.tsx"
];
const ATTACHMENTS_NAMES: string[] = [
  "Profile.tsx"
];
const ATTACHMENTS_DIRECTORY = "public/180833/attachmentss";
...
export const processData = async (
  ...
  try {
    ...
    // Prepare the prompt
    const generatedPrompt = "\n\nFollow these instructions strictly:use tailwind dont use any compoennt from atatchment file and create a new tsx file to sue in next js using tailwind no compoentns to be used \nValidation: error free\n" + inputText;
